...
INSERT IGNORE INTO users VALUES ('root', '{noop}EazyBytes@12345', '1');
INSERT IGNORE INTO authorities VALUES ('root', 'read');

INSERT IGNORE INTO users VALUES ('admin', '{bcrypt}$2a$12$QJ0Taq6Ybc6WoQf5xHOnpuNSh4Lg.rgGtd1sqioLWo74rmyO.4Fi2', '1');
...
Insert into Customer (email, password, role) values ('happy@exmaple.com', '{noop}EazyBytes@12345', 'read');
Insert into Customer (email, password, role) values ('admin@exmaple.com', '{bcrypt}$2a$12$QJ0Taq6Ybc6WoQf5xHOnpuNSh4Lg.rgGtd1sqioLWo74rmyO.4Fi2', 'admin');
